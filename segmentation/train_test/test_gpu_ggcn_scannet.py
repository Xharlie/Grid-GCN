...
class ScanNetSolver(BaseSolver):
    ...
    def _get_data_loaders(self):
        ...
        self.val_loader = ScanNetWholeSceneLoader(
            ...
            cache_file='ggcn_gpu_whole_scene_cache_8192_{}_py3.pickle'.format(configs["batch_size"]) if sys.version_info[0] == 3
            else 'ggcn_gpu_whole_scene_cache_8192_{}.pickle'.format(configs["batch_size"])
        )
        ...
        for i, batch in enumerate(self.val_loader):
            ...
            for b in range(self.val_loader.batch_size):
                ...
                if valid_ids.size > 0:
                    ...
                    _, uvlabel_02 = point_cloud_label_to_surface_voxel_label_major(valid_data, stacked_label, res=0.02)
                    _, uvlabel_0484 = point_cloud_label_to_surface_voxel_label_major(valid_data, stacked_label, res=0.0484)
