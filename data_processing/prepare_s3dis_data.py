...
def main():
    ...
    parser.add_argument('--max_point_num', '-m', help='Max point number of each sample', type=int, default=12288)
    ...
    for area_idx in range(1, 7):
        ...
        for dataset_idx, dataset in enumerate(datasets):
            ...
            for offset_name, offset in offsets:
                ...
                block_point_count_threshold = max_point_num/5
                ...
                print('{}-{} of {} blocks are removed.'.format(datetime.now(), block_merge_count, blocks.shape[0]))
